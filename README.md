...
# Latest prerelease
github "mapbox/mapbox-directions-swift" "v2.0.0-beta.9"
```
...
# Latest prerelease
pod 'MapboxDirections-pre', '2.0.0-beta.9'
```
...
// Latest prerelease
.package(name: "MapboxDirections", url: "https://github.com/mapbox/mapbox-directions-swift.git", from: "2.0.0-beta.9")
```
